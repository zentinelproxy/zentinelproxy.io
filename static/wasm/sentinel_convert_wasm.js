 ...
 * @returns {any}
 */
export function convert(config, format) {
    const ptr0 = passStringToWasm0(config, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(format) ? 0 : passStringToWasm0(format, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
 ...
 * @returns {any}
 */
export function detect_format(config) {
    const ptr0 = passStringToWasm0(config, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
export function validate(config, format) {
    const ptr0 = passStringToWasm0(config, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(format) ? 0 : passStringToWasm0(format, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
    var len1 = WASM_VECTOR_LEN;
